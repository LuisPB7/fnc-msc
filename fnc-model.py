...
transform_layer = TimeDistributed(Dense( word_embeddings_dim, activation='sigmoid', name='transform' ))
...
g1 = gru1(embed)
drop1 = Dropout(0.01)(g1)
g2 = gru2(drop1)
drop2 = Dropout(0.01)(g2)
att = SelfAttLayer(name='attention')(drop2)
...
body_shortcut = merge([body_sentence, body_g1], mode='concat')
body_drop1 = Dropout(0.01)(body_shortcut)
body_g2 = right_branch_gru2(body_drop1)
body_drop2 = Dropout(0.01)(body_g2)
body_att = SelfAttLayer()(body_drop2)
...
dif = merge([headline_representation, document_representation],
                    mode=lambda x: x[0] - x[1], output_shape=lambda x: x[0])
